...
public class Browser {
    ...
    private static void init() {
        ...
        ChromeDriverManager.getInstance().version("2.24").arch64().setup();
        //=================================================================
...
//                    until(ExpectedConditions.visibilityOfElementLocated());//if this invoked from waitAndClick we will wait 2 sec by def
//        } catch (Exception e) {
//        }
        //===
        long timeElapsed = (System.currentTimeMillis() - timeStart) / 1000;
...
//            try {
//                sMsgTxtActual = (new WebDriverWait(get(), 3)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(sXPath_FlashMsg));
//            } catch (Exception e) {
//            }
